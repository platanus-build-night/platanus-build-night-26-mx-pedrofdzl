# Pedro Fernández — Platanus Build Night — Ciudad de México Project
...
- Pedro Fernández ([@pedrofdzl](https://github.com/pedrofdzl))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-build-night/platanus-build-night-26-mx-pedrofdzl.git
